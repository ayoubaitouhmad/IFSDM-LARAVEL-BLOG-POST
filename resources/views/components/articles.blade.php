    ...
    <div class="container mx-auto bg-white p-6 rounded-lg shadow-sm">
        ...
        @if($showHeader)
            <div class="">
                <div class=" border-gray-200">
                    <div class="container mx-auto px-6 py-4">
                        <div class="flex items-center justify-between">
                            ...
                            @isset($currentUser)
                                <button class="inline-flex items-center gap-2 px-4 py-2 bg-purple-600 text-white rounded-lg hover:bg-purple-700 transition-colors">
                ...
                <form action="{{ route('articles.index') }}" method="get" id="f-form">
                        ...
                        <div class="container mx-auto px-6 py-4">
                            <div class="flex items-center justify-between gap-4">
                                ...
                                <div class="flex items-center gap-3">
                                    ...
                                    <x-form.select placeholder="order by" wrapper-class="flex" :value="request('f-orderBy')" name="f-orderBy" label="trie par" :options="$orderByOptions"
                                    ...
                                    <!-- Filter Button -->
                                    <button  id="btn-show-filters"   class="inline-flex items-center gap-2 px-4 py-2 border border-gray-300 rounded-lg hover:bg-gray-50 transition-colors"
                                        ...
                                        <span class="inline-flex items-center justify-center w-6 h-6 text-xs font-medium text-white bg-purple-600 rounded-full">
                                            {{$activeFilters}}
                                        </span>
                                    </button>
                            ...
                            <div id="filtersPanel" class="hidden mt-4 pt-4 ">
                                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                                    <!-- Category Filter Group -->
                                    <div>
                                        <x-form.select placeholder="author" name="f-author" label="Author" :options="$users"
                                    ...
                                    <div>
                                        ...
                                        <div class="flex gap-2">
                                            <input name="f-startDate" type="date" placeholder="Min"
                                                  value="{{ request('f-startDate') }}" class="w-1/2 px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-purple-500">
                                            <input name="f-endDate" value="{{ request('f-endDate') }}"  type="date" placeholder="Max"
                                ...
                                <div class="flex items-center justify-between mt-4 pt-4 ">
                                    <button  type="reset" id="f-btn-reset-form"   class="text-sm text-gray-600 hover:text-gray-800 font-medium">
                                        Clear All Filters
                                    </button>
                                    <div class="flex gap-2">
...
<script>
    ...
    document.getElementById("f-btn-reset-form").addEventListener('click', function(e) {
        e.preventDefault();
        document.querySelector('[name="f-search"]').value="";
        document.querySelector('[name="f-orderBy"]').value="";
        document.querySelector('[name="f-author"]').value="";
        document.querySelector('[name="f-startDate"]').value="";
        document.querySelector('[name="f-endDate"]').value="";
